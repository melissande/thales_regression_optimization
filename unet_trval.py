...
class Trainer(object):
    ...
    def _get_optimizer(self, training_iters, global_step):
        if self.optimizer == "momentum":
            learning_rate = self.opt_kwargs.pop("learning_rate", 0.001)#0.2
            ...
            learning_rate = self.opt_kwargs.pop("learning_rate", 0.001)#0.001
    ...
    def _initialize(self, training_iters, output_path, restore):
        ...
        tf.summary.scalar('l2_loss', self.net.l2_loss)
    ...
    def store_prediction(self, sess, batch_x, batch_y,  name):
        ...
        loss = sess.run(self.net.l2_loss, feed_dict={self.net.x: batch_x, 
                                                       self.net.y: util.crop_to_shape(batch_y, pred_shape), 
                                                       self.net.keep_prob: 1.})
